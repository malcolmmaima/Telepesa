    ...
    return (
      <div className="space-y-2">
        ...
        <input
          ...
          className={cn(
            'input',
            error && 'border-financial-danger focus:ring-financial-danger focus:border-financial-danger',
...
export const TextArea = forwardRef<HTMLTextAreaElement, Omit<InputProps, 'onChange' | 'onBlur'> & {
