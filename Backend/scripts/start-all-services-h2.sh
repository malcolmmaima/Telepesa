...
# Telepesa All Services Startup Script (H2 Database)
# Starts all microservices with H2 in-memory database for testing
...
echo -e "${BLUE}🚀 Starting Telepesa All Services with H2 Database${NC}"
...
if [ ! -d "shared-libraries" ]; then
    ...
    echo -e "${YELLOW}💡 Run: cd Backend && ./scripts/start-all-services-h2.sh${NC}"
    exit 1
fi
...
# 1. User Service (already uses H2 in dev profile)
start_service "User Service" "user-service" "8081" "dev"

# 2. Account Service
start_service "Account Service" "account-service" "8082" "dev-h2"

# 3. Transaction Service  
start_service "Transaction Service" "transaction-service" "8083" "dev-h2"

# 4. Loan Service
start_service "Loan Service" "loan-service" "8084" "dev-h2"

# 5. Notification Service
start_service "Notification Service" "notification-service" "8085" "dev-h2"
...
echo -e "\n${BLUE}🗄️ H2 Database Consoles:${NC}"
echo -e "🏦 Account Service: ${BLUE}http://localhost:8082/h2-console${NC}"
echo -e "💳 Transaction Service: ${BLUE}http://localhost:8083/h2-console${NC}"
echo -e "💰 Loan Service: ${BLUE}http://localhost:8084/h2-console${NC}"
echo -e "📧 Notification Service: ${BLUE}http://localhost:8085/h2-console${NC}"
...
echo -e "\n${GREEN}🎉 All services are now running and ready for testing!${NC}" 