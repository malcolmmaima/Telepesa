      ...
      case 'success':
        return (
          <div className="w-8 h-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center">
            <svg className={`${iconClasses} text-green-600 dark:text-green-400`} fill="currentColor" viewBox="0 0 24 24">
      ...
      case 'warning':
        return (
          <div className="w-8 h-8 rounded-full bg-yellow-100 dark:bg-yellow-900/30 flex items-center justify-center">
            <svg className={`${iconClasses} text-yellow-600 dark:text-yellow-400`} fill="currentColor" viewBox="0 0 24 24">
      ...
      case 'error':
        return (
          <div className="w-8 h-8 rounded-full bg-red-100 dark:bg-red-900/30 flex items-center justify-center">
            <svg className={`${iconClasses} text-red-600 dark:text-red-400`} fill="currentColor" viewBox="0 0 24 24">
      ...
      default: // 'info'
        return (
          <div className="w-8 h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center">
            <svg className={`${iconClasses} text-blue-600 dark:text-blue-400`} fill="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-slate-800 rounded-financial-lg shadow-financial-lg border border-gray-100 dark:border-slate-700 z-50 max-h-[32rem] flex flex-col">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-slate-700">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <svg className="w-4 h-4 text-financial-gray dark:text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="m6 6 12 12m0-12L6 18" />
              </svg>
            </button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto">
          {loading ? (
            <div className="p-4 text-center">
              ...
              <p className="text-sm text-financial-gray dark:text-slate-400">Loading notifications...</p>
            </div>
          ) : error ? (
            ...
            <div className="p-6 text-center">
              <svg className="w-12 h-12 text-financial-gray dark:text-slate-500 mx-auto mb-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M15 17h5l-5 5v-5zM4 19h11M4 15h11M4 11h11M4 7h11" />
              </svg>
              <p className="text-sm text-financial-gray dark:text-slate-400">No notifications yet</p>
              <p className="text-xs text-financial-gray/70 dark:text-slate-500 mt-1">We'll notify you when something happens</p>
            </div>
          ) : (
